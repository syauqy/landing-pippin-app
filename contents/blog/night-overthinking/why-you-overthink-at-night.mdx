...
## **Quick Context Shift (Right Now)**

Before we dive into the "why," here's the immediate "what to do":

**The Quick Quiet** (60 seconds):

1. Your overthinking at night = evolutionary. Your brain's job is to process.
2. That's not a flaw. That's your brain _working_.
3. Instead of "stop overthinking," try: "I'll let my brain process for 5 minutes, then ask it to pause."
4. Set a phone timer: 5 minutes. Process away.
5. When timer goes off: "Thanks for working. Now sleep time."

**Why changing the frame matters:** Fighting your brain makes it rebel harder. Working _with_ it ("you can process for 5 min") lets it release.

Night overthinking isn't a disorder. It's hyperactive processing. The secret: redirect it, don't eliminate it.
