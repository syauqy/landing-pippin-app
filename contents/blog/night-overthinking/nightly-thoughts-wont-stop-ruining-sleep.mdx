...
## **Stop Thoughts From Ruining Sleep (3-Minute Pause)**

Thoughts don't stop. You _pause_ them:

**The Thought Pause** (3 minutes):

1. When thoughts won't stop, literally **pause** (like pressing pause on a video)
2. Say mentally: "I'm pausing this thought for now."
3. Ask yourself: "Can I solve this RIGHT NOW?" (Usually: No)
4. If no: "This is scheduled for tomorrow morning. Thought is sleeping now."
5. Redirect to: listening (room sounds) or feeling (blanket weight)

**Key:** Thoughts don't know the difference between you dismissing them and you saving them for later. Your brain trusts the "scheduled for later" approach.

Thoughts stop ruining sleep when you treat them as _schedulable_ rather than _always urgent_.
