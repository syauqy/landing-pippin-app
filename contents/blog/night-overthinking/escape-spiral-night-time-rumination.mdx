...
## **Break the Rumination Loop in 3 Minutes**

When you notice yourself spiraling (same thought cycling over):

**Step 1:** Name the spiral ("I'm replaying that conversation") — this creates distance
**Step 2:** Ask: "Is there action I can take _right now at 2 AM_?" (Answer: No)
**Step 3:** Say out loud: "This thought is trying to solve something that cannot be solved right now."
**Step 4:** Redirect to one physical sensation (cold pillow, soft sheets) — anchor there for 1 minute

**Research shows:** Naming rumination + acknowledging it's unsolvable + redirecting to the present reduces spiral duration by 50%+ in practice.

Spirals thrive on being implicit (hidden mental loops). Making them explicit kills them.
