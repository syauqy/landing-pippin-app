...
import { LoadingProfile } from "../layouts/loading-profile";

export function PageLoadingLayout({ profileData, showTitleInNavbar, router }) {
  return (
    <div className="min-h-screen bg-base-100 text-base-content font-sans">
      ...
      />
      <div className="p-5 animate-pulse bg-base-100 md:p-6 max-w-3xl mx-auto space-y-6 pb-16">
