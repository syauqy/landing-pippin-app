 ...
 * Keep this list TIGHT - only truly harmful/diagnostic phrases
 */
export const bannedPhrases = [
  // Clear diagnostic/prescriptive statements
  "treatment plan",
  "treat your",
  "clinically proven",
  "mental illness",
...
export const warningPhrases = {
  // Previously in bannedPhrases but too broad - auto-replace instead
  "you suffer from": "you experience",
  "you are diagnosed": "you are experiencing",
  "your condition": "your experience",
  "your disorder": "your experience",
  "medical condition": "experience",
  "diagnose": "identify",
  "diagnosis": "understanding",
  "disorder": "challenge",
  "studies show that": "research suggests that",
  "fix your": "support your",
  "eliminate your": "reduce your",
  "get rid of": "ease",
  "completely stop": "help quiet",

  // Original warning phrases
